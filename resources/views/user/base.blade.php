                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto mb-lg-0">
                        ...
                        <li class="nav-item dropdown profile-nav-item">
                            <a class="nav-link dropdown-toggle avatar" href="#" id="navbarDropdown-4" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{empty($user->photo)?'https://ui-avatars.com/api/?name='.$user->name:asset('dashboard/user/images/'.$user->photo)}}"
                                    alt="Images" class="rounded-circle" style="width: 50px;">
                                <h3>{{$user->name}}</h3>
                                <span>Investor</span>
                            </a>
...
{{--    _smartsupp.key = 'fc274e0b0e9ee5762120059498d0b25fd2b2d045';--}}
...
{{--    <noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>--}}
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/66fc3e18e5982d6c7bb75313/default';
            s1.charset='UTF-8';
