            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.notification.edit',['id'=>$promo->id])}}" class="btn btn-primary"
                                style="margin-bottom: 5px;">
                                <i class=""></i> Edit
                            </a>
                            <a href="{{route('admin.notification.delete',['id'=>$promo->id])}}" class="btn btn-danger">
                                <i class=""></i> Delete
                            </a>
                        </td>
                    </tr>
                ...
                <form method="post" action="{{route('admin.notification.new')}}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select type="text" class="form-control" id="inputAddress" name="status">
